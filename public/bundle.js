...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = __webpack_require__(220);
	var Profile = __webpack_require__(221);
	...
	var Home = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(Header, { className: 'bar bar-nav', text: 'All Emplyees' }),
	            React.createElement(
	                'a',
	                { href: '#', className: 'icon icon-left-nav pull-left' },
	                'this'
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'bar bar-standard navbar-header-secondary' },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    null,
	                    ' ',
	                    this.props.employee.head_of_department
	                )
	            )
	        );
	    }
	...
	var EmployeeList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var items = this.props.names.map(function (employee) {
	            return React.createElement(EmployeeListItem, { key: employee.id, onClick: onClickfunc, employee: employee });
	        });
	        return React.createElement(
	            'ul',
	            null,
	...
	var Profile = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var Employees = [{ id: 1, head_of_department: 1, first_name: "Ron", last_name: "Vrijmoet", img: "test.jpg" }, { id: 2, head_of_department: 0, first_name: "Richard", last_name: "Olyerhoek" }, { id: 3, head_of_department: 1, first_name: "Nick ", last_name: "Mueller" }, { id: 100, head_of_department: 0, first_name: "Silviu", last_name: "Agapi" }];

	        return React.createElement(
	            'div',
	            { className: 'container' },
	            React.createElement(SearchBar, null),
	            React.createElement(EmployeeList, { names: Employees })
	        );
	    }
	});
